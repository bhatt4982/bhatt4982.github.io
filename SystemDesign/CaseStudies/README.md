...
1. [Designing a parking lot](Generic\parking_lot.md)
1. [Designing a traffic control system](Generic\traffic_control_system.md)

## Generic Problems
1. [Designing a Message Queue](Generic\message_queue.md)
1. [Designing a LRU Cache](Generic\lru_cache.md)
1. [Designing an API rate limiter](Generic\api_rate_limiter.md)
1. [Designing Type Ahead Suggestions](Generic\type_ahead.md)
1. [Designing a Matching engine](Generic\matching_engine.md)
1. [Designing Web Crawler](Generic\web_crawler.md)
...
1. [Designing Social Media Platform - FaceBook or Instagram](Problems/social_media.md)
1. [Designing Video aggregator or streaming service - Youtube or Netflix](Problems/video_service.md)
1. [Designing Near-by Services - Yelp/FourSquare](Problems/near_by.md)
...
1. [Designing a Code Deployment System](Problems/code_deploy.md)
